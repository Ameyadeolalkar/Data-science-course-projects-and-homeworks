...
<<<<<<< HEAD
drinks = pd.read_table('drinks.csv', sep = ',' , index_col = 'country')
...
>>>>>>> d1ef3c4fcd0409d15d34a4180e40e14d9f3087f8
...
ufo.rename(columns={'Color Reported':'Colors_Reported','Shape Reported':'Shape_Reported'})
...
ufo.coulmns  = [column.replace(' ','_') for column in ufo.columns]
